...
-- CreateIndex
CREATE INDEX "DigitalAsset_areaId_projectId_idx" ON "DigitalAsset"("areaId", "projectId");

-- CreateIndex
CREATE INDEX "Idea_areaId_projectId_idx" ON "Idea"("areaId", "projectId");

-- CreateIndex
CREATE INDEX "DueItem_dueDate_status_idx" ON "DueItem"("dueDate", "status");

-- CreateIndex
CREATE INDEX "DueItem_projectId_assetId_idx" ON "DueItem"("projectId", "assetId");

-- CreateIndex
CREATE INDEX "Review_nextReviewDate_status_idx" ON "Review"("nextReviewDate", "status");

-- CreateIndex
CREATE INDEX "Review_areaId_projectId_idx" ON "Review"("areaId", "projectId");

-- CreateIndex
CREATE INDEX "Note_areaId_projectId_idx" ON "Note"("areaId", "projectId");
